...
import supabase from '../utils/supabase'; // adapt if path differs
...
export default function ProductPage() {
  ...
  if (!userEmail) return <div>Please login and verify email to buy.</div>;

  return (
    <div className="p-6">
      <h2 className="text-xl font-bold">Buy Full Data Access</h2>
      <p className="mb-4">Price: $10.00</p>
      <PayPalButton amount="10.00" userEmail={userEmail} onSuccess={(c)=>{ alert('Payment success'); console.log(c); }} onError={(e)=>{ alert('Payment failed'); console.error(e); }} />
    </div>
  );
}
